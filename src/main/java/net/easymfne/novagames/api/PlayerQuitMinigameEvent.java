...
/**
 * Cancellable event representing a player quitting a Minigame.
 */
public class PlayerQuitMinigameEvent extends Event implements Cancellable {
   ...
   */
  public PlayerQuitMinigameEvent(Player player, Minigame minigame, Location destination,
  ...
  /**
   * @return The Player quitting the Minigame.
   */
  ...
  /**
   * @return Whether the event has been cancelled (and thus the Player will not be allowed to quit).
   */
  @Override
