 ...
 */
package net.easymfne.novagames.test;

/**
 * Class used for testing plugin functionality using the JUnit framework. Testing is important for
 * detecting bugs and tracking the effects of changes.
 */
public class NovaGamesTestSuite {
